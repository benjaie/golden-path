...
[First-party API](/roles/server/first-party) &mdash; APIs intended to power
...
controlled by the same organization that develops the GraphQL API. It's also
much easier to open an API up later than it is to lock it down once it has
already shipped!
